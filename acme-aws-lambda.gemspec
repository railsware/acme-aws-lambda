...
Gem::Specification.new do |spec|
  ...
  spec.summary       = 'AWS Lambda script to generate Letsencrypt certs'
  spec.description   = 'AWS Lambda script to generate Letsencrypt certs'
  spec.homepage      = 'https://github.com/railsware/acme-aws-lambda'
  spec.license       = 'MIT'
